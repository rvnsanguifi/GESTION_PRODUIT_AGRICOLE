...
public class Transporteur extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("<title>Consultation des Transporteurs</title>");
		...
		out.println("<h1>Voici la liste des Transporteurs </h1>");
		...
		out.println("<label>Transporteur</label> ");
		...
		out.println("<br>");
			 ...
			 for(int i=0;i<resultat.size();++i)
			 {
				 resultat_final=(Vector)resultat.elementAt(i);
					...
					out.println("<tr><th>Code du Transporteur</th><td>"+resultat_final.elementAt(0)+"</td></tr>");
					out.println("<tr style=\"background-color:#DAFAC9;\"><th>Nom du Transporteur</th><td>"+resultat_final.elementAt(1)+"</td></tr>");
